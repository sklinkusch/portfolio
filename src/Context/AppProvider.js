      ...
      CVContent: [
        {
          list: [
            ...
            },
            {
              ...
              desc: (
                <span>
                  Diploma thesis in the group of Prof. P. Saalfrank at
            ...
            },
            {
              ...
              desc: (
                <span>
                  Ph.D thesis in the group of Prof. P. Saalfrank at University
                  of Potsdam, Germany
                </span>
              )
            },
      ...
      talks: [
        {
          ...
          article: null,
          place: (
            <span>Bundesinstitut für Risikobewertung, Berlin, Germany</span>
          ),
          date: (
            <span>
        ...
        },
        {
          title: (
            <q className="arttitle">
              Time-resolved photoelectron spectra using explicitly
              time-dependent <abbr title="configuration interaction">CI</abbr>{" "}
              varitaions
            </q>
          ),
          article: null,
        ...
        },
        {
          ...
          place: (
            <span>
              Theoretical Chemistry Group Seminar, Humboldt University of
              Berlin, Germany
            </span>
          ),
          date: (
        ...
        },
        {
          ...
          place: (
            <span>
              Theoretical Chemistry Group Seminar, University of Potsdam,
              Germany
            </span>
          ),
          date: (
        ...
        },
        {
          ...
          article: null,
          place: (
            <span>Tag der Chemie, Free University of Berlin, Germany</span>
          ),
          date: (
            <span>
        ...
        },
        {
          title: (
            <q className="arttitle">
              A rough model describing effects of photoionization as an
              extension to{" "}
              <abbr title="time-dependent configuration interaction singles">
                TD-CIS
              </abbr>
      ...
      references: [
        {
          title: (
            <span>
              Workgroup of Prof. P. Saalfrank at University of Potsdam
            </span>
          ),
        ...
        },
        {
          title: (
            <span>
              ...
              <span className="italic">(Sonderforschungsbereich)</span> Sfb450
              for funding
            </span>
          ),
