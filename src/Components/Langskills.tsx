    ...
    <section sx={{ margin: '30px 0' }}>
        ...
        <Progress bar value="33.3" style={{ paddingLeft: '15px' }} barStyle={{ backgroundColor: '#000000' }}>
          <span
            sx={{
              ...
              fontWeight: 'bold',
              color: 'wwhite',
              '@media screen and (min-width: 451px)': { display: 'inline' },
            }}
          >
            German (native)
          </span>
          <span
            sx={{
              ...
              fontWeight: 'bold',
              color: 'wwhite',
              '@media screen and (min-width: 451px)': { display: 'none' },
            }}
          >
            German
          </span>
      ...
      <Progress multi sx={{ my: '20px' }}>
        ...
        <Progress
          bar
          value="25"
          barStyle={{ backgroundColor: '#FFFFFF', borderTop: '1px solid black', borderBottom: '1px solid black' }}
        />
